...
| [generador-politica-privacidad](./generador-politica-privacidad) | Genera la Política de Privacidad, la Política de Cookies y el Aviso Legal de una web adaptados a 8 jurisdicciones (RGPD/LOPDGDD, LFPDPPP, CCPA…), con exportación a Markdown y HTML y 34 pruebas automáticas ([Demo en vivo](https://agc-generador-politica-privacidad.pages.dev)) | HTML/CSS/JS vanilla + módulo UMD para Node | 2026-08-03 |
| [divisor-gastos-grupo](./divisor-gastos-grupo) | Reparte los gastos de un viaje o piso compartido (por gasto y con pesos por persona) y calcula los pagos mínimos —como mucho N-1— para dejar las cuentas a cero, con cálculo exacto en céntimos y 25 pruebas automáticas ([Demo en vivo](https://agc-divisor-gastos-grupo.pages.dev)) | HTML/CSS/JS vanilla + módulo UMD para Node | 2026-08-04 |
| [Calculadora de Hipoteca](./calculadora-hipoteca) | Calcula cuota mensual, total e intereses de una hipoteca con tabla de amortización y gráfico | HTML, CSS, JavaScript vanilla | 2026-08-05 |
